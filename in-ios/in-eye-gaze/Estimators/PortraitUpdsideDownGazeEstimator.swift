//
//  PortraitUpdsideDownGazeEstimator.swift
//  in-ios
//
...
class PortraitUpdsideDownGazeEstimator: GazeEstimatorProtocol {
    ...
    func predictGaze(eyesB: MLMultiArray, eyesG: MLMultiArray, eyesR: MLMultiArray, illuminant: MLMultiArray, headPose: MLMultiArray) -> (gazeXY: Array<NSNumber>?, calibFeats: MLMultiArray?)? {
        ...
        do {
            let horizontalOutput = try horizontalModel.prediction(input: GeneralModelHorizontalInput(eyesB: eyesB, eyesG: eyesG, eyesR: eyesR, illum: illuminant, pose: headPose), options: self.predictionOptions)
            ...
            print("Generated prediction for portrait upside-down orientation.")
